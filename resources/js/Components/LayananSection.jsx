...
const LayananSection = () => {
    const titleLayanan = [
        ...
        { key: "poli-umum", label: "POLI UMUM", img: IconPoliUmum },
        { key: "poli-anak", label: "POLI ANAK", img: IconPoliAnak },
        { key: "poli-gigi", label: "POLI GIGI", img: IconPoliGigi },
        { key: "apotek", label: "APOTEK", img: IconApotek },
        { key: "labor", label: "LABORATORIUM", img: IconLabor },
        { key: "kia", label: "KIA", img: IconKia },
    ];
