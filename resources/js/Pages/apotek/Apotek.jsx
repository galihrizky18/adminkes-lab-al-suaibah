    ...
    return (
        <MantineProvider>
            ...
            <div className="w-full h-full flex flex-col gap-5 justify-center items-center p-5 sm:p-10 ">
                ...
                <div className="bg-[#278645] w-full sm:w-full md:w-[90%] lg:w-[80%] xl:w-[70%] 2xl:w-[50%] mx-auto shadow-lg text-white px-4 py-4 sm:px-6 sm:py-5 rounded-xl hover:scale-110 transition-all mt-5 sm:mt-8 md:mt-12 lg:mt-16">
                    ...
                    <div className="text-white-500 text-sm sm:text-base md:text-lg lg:text-xl text-justify">
                        Pelayanan farmasi merupakan salah satu standar pelayanan
                        kefarmasian yang harus ada di apotek sesuai dengan
                        peraturan yang berlaku. Selain untuk memenuhi standar
                        pelayanan apotek, aspek pelayanan farmasi klinik di
                        apotek juga dapat meningkatkan nilai jual apotek. Tidak
                        hanya itu, memberikan pelayanan yang baik di apotek juga
                        dapat meningkatkan jumlah pelanggan, omzet, dan membuat
                        pelanggan loyal terhadap apotek. Disini akan dibahas
                        mengenai pelayanan farmasi yang bisa dilakukan di apotek
                        dan berbagai kiat untuk meningkatkan pelayanan di
                        apotek.
                    </div>
                </div>
            ...
            <div className="border-4 border-solid border-[#278645] rounded-lg p-4 md:p-6 lg:p-8 max-w-md mx-auto md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#278645] mb-2 md:mb-4">
                    Area fasilitas pelayanan kesehatan
                </h2>
                <p className="text-sm md:text-base lg:text-lg text-[#278645] text-justify">
                    Anda bisa mengamati apa saja fasilitas kesehatan yang ada di
                    sekitar apotek. Seperti rumah sakit, klinik, puskesmas, atau
                    dokter praktik mandiri. Hal ini akan berpengaruh pada jenis
                    produk apa saja yang kebanyakan dicari pelanggan setelah
                    mengunjungi fasilitas pelayanan kesehatan tersebut. Contoh,
                    jika apotek berada di sekitar rumah sakit, Anda bisa
                    menyediakan sediaan farmasi terutama untuk pengobatan
                    kronis, multivitamin, dan alat kesehatan. Untuk klinik,
                    dapat dilihat pelayanan kliniknya, apakah klinik kecantikan,
                    klinik bersalin, klinik gigi, atau klinik umum. Untuk klinik
                    gigi, Anda dapat menyediakan obat kumur, dental flos, obat
                    anti nyeri dan pasta gigi khusus.
                </p>
                <img
            ...
            <div className="w-full p-4 flex flex-col items-center bg-[#278645] mt-8 sm:mt-20">
                <div>
                    <h2 className="text-2xl sm:text-4xl mb-4 border-b-2 border-[#ffffff] text-white text-center">
                        Gambar Area Fasilitas Apotek
                    </h2>
                </div>
                <div className="flex flex-col sm:flex-row gap-5 sm:gap-8 ml-4 sm:ml-0">
                    ...
                    <div className="flex flex-col gap-4 p-4 w-full sm:w-full md:w-[350px] lg:w-[350px] bg-[#ffffff] rounded-xl shadow-md hover:scale-110 transition-all duration-200">
                        <img
                            src="https://i.pinimg.com/236x/eb/96/3d/eb963da11b875eb996ac6690039c3bf5.jpg"
                            alt=""
                    ...
                    <div className="flex flex-col gap-4 p-4 w-full sm:w-full md:w-[350px] lg:w-[350px] bg-[#ffffff] rounded-xl shadow-md hover:scale-110 transition-all duration-200">
                        <img
                            src="https://i.pinimg.com/236x/3c/4b/3e/3c4b3ed833bc3c0fc2ed30971c8f7f80.jpg"
                            alt=""
                            className="w-full h-auto rounded-xl"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-4 p-4 w-full sm:w-full md:w-[350px] lg:w-[350px] bg-[#ffffff] rounded-xl shadow-md hover:scale-110 transition-all duration-200">
                        <img
                            src="https://i.pinimg.com/564x/5c/00/4b/5c004b7ee153412f3e4a6604c29a22db.jpg"
                            alt=""
                            className="w-full h-auto rounded-xl"
                        />
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-5 sm:gap-8 p-4 mt-4">
                    ...
                    <div className="flex flex-col gap-4 p-4 w-full sm:w-full md:w-[350px] lg:w-[350px] bg-[#ffffff] rounded-xl shadow-md hover:scale-110 transition-all duration-200">
                        <img
                            src="https://i.pinimg.com/236x/0f/75/09/0f75098af9a4bfaef2c7ddf766f2354b.jpg"
                            alt=""
                            className="w-full h-auto rounded-xl"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-4 p-4 w-full sm:w-full md:w-[350px] lg:w-[350px] shadow-md rounded-xl bg-[#ffffff] hover:scale-110 transition-all duration-200">
                        <img
                            src="https://scontent.fplm4-1.fna.fbcdn.net/v/t39.30808-6/299693852_415644360547814_4343029053923731381_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=K4AA6L_kW5gAX90j_vc&_nc_ht=scontent.fplm4-1.fna&oh=00_AfBWOOvmvcoWtycaei9w2a7wa-orCpmj9aVrjUmGPxJM6A&oe=65D05144"
                            alt=""
                            className="w-full h-auto rounded-xl"
                        />
                    </div>
            ...
            <div className="bg-[#1e4aa8] w-full sm:w-full md:w-[90%] lg:w-[80%] xl:w-[70%] 2xl:w-[50%] mx-auto shadow-lg text-white px-4 py-4 sm:px-6 sm:py-5 rounded-xl hover:scale-110 transition-all mt-5 sm:mt-8 md:mt-12 lg:mt-16">
                ...
                <div className="text-white-500 text-justify text-sm sm:text-base md:text-lg lg:text-xl">
                    <p>
                        Apotek STIKES AL-SU'AIBAH PALEMBANG berkomitmen untuk
                        memberikan pelayanan kesehatan terbaik kepada
                        masyarakat. Dengan tim profesional dan produk
                        berkualitas, kami siap mendukung kebutuhan kesehatan
                        Anda.
                    </p>
                    <p style={{ marginTop: "15px" }}>
                        Apotek STIKES AL-SU'AIBAH PALEMBANG merupakan bagian
                        integral dari lembaga pendidikan tinggi STIKES
                        AL-SU'AIBAH yang berkomitmen untuk memberikan layanan
                        kesehatan terbaik kepada mahasiswa, tenaga pengajar, dan
                        masyarakat sekitar. Apotek ini berperan penting dalam
                        mendukung kebutuhan obat dan perawatan kesehatan bagi
                        seluruh komunitas kampus.
                    </p>
                    <p style={{ marginTop: "15px" }}>
                        Laboratorium Prodi S1 Administrasi Kesehatan di STIKES
                        AL-SU'AIBAH PALEMBANG memberikan pengalaman praktis yang
                        mendalam kepada mahasiswa. Laboratorium ini dirancang
                        untuk memfasilitasi pembelajaran teori yang diperoleh
                        dalam program S1 Administrasi Kesehatan melalui
                        pengalaman praktis yang terintegrasi.
                    </p>
                    <p style={{ marginTop: "15px" }}>
                        Dengan peralatan dan fasilitas modern, laboratorium ini
                        memungkinkan mahasiswa untuk mengembangkan keterampilan
                        praktis dalam manajemen administrasi kesehatan, termasuk
                        pengelolaan inventaris, penanganan informasi pasien, dan
                        proses administratif lainnya. Prodi ini bertujuan untuk
                        melahirkan lulusan yang siap terjun ke dunia
                        administrasi kesehatan dengan pengetahuan yang kuat dan
                        keterampilan praktis yang diperoleh dari pengalaman
